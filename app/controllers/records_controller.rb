...
# GET list all records
  def index
    ...
    if !current_user || !current_user.institution_id
      login and return
    end  
  ...
  def create
    ...
    @record.institution_id = current_user.institution_id
  ...
  def update
    ...
    @institution = current_user.institution
    @record = Record.find(params[:id])
    @record.institution_id = current_user.institution_id if @record.institution_id.nil?
  ...
  def send_archive_to_merritt
    ...
    if !@record.required_fields.empty?
      ...
      @record.generate_merritt_zip
       ...
       @merritt_request = @record.send_archive_to_merritt (current_user.external_id)
